...
if __name__ == "__main__":
    import os
    # Use relative path since we moved the script
    script_dir = os.path.dirname(os.path.abspath(__file__))
    geojson_path = os.path.join(script_dir, 'export.geojson')
    output_path = os.path.join(script_dir, 'istanbul_gas_stations_map_mpl.png')
